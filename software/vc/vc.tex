...
the other people sharing the same {\tt github} repository.
...
\begin{itemize}
\item Do {\tt git pull} often so that conflicts can be discovered
  earlier when only a few lines of conflicts exist.
\item 
\end{itemize}  
