...
Typeless
 ...
 or
\emph{dynamically typed} language. That means that variables do not have
types; values have types. Variables are not declared. A value of any
...
command prompt ( \emph{\textgreater{}\textgreater{}\textgreater{}} ):

%\paragraph[{[}user@hostname
%user{]}python]{}user@hostname
%user{]}python}{{[}user@hostname tc{]}python}}\label{tctclinux-tcpython}

Python 1.5.2 (\#0, Apr 13 1999,
10:51:12) {[}MSC 32 bit (Intel){]} on win32
