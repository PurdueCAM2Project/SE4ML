...
\begin{table}[h]
  ...
  \begin{tabular}{ll}
    ...
    Paper width & Blah \\
    Paper height & Blah \\
    Textblock width & Blah \\
    Textblock/sidenote gutter & Blah \\
    Sidenote width & Blah \\
    \bottomrule
  \end{tabular}
...
%\fontfamily{ppl}\selectfont
  \begin{tabular}{llp{5cm}}
    ...
    \midrule
    1 & x or y &  This is the logical OR operation.
...
expression. Other values than a number zero also count as zero. \\
    2 & x and y & This is the logical AND operation.
...
also count as zero. \\
    \bottomrule
  \end{tabular}
  \caption{Operators and Precedence Levels}
  \label{tab:operators-and-precedence-levels}
\end{table}
